...
import com.limbergdv.vivia_mobile.features.users.lessors.data.datasources.remote.dtos.LessorRegistrationResponseDto
...
interface LessorApi {
    ...
    suspend fun verifyRegistration(@Body request: VerifyLessorRegistrationDto): Response<BaseResponse<LessorRegistrationResponseDto>>
